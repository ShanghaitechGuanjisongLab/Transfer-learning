% 英文图1F（分层变体，备用）：Divergence vs 首会话命中率 散点图 — 2×2 (L2/3 vs L5) × (Naive vs Transfer)
% 当前图1的 F 面板为合并层版本，见 英文图/Fig1F_DivVsHitRate_Scatter.m
%
...
%% ===== 作图 (2×2 tiledlayout) =====
f = figure('Color', 'w', 'Name', 'English Fig1F ByLayer Div vs Hit Rate 2x2');
f.Units = 'centimeters';
f.Position(3:4) = [6, 4];
...
svgPath = TransferLearning.ExportStandardFigure(f, 1, "English_Fig1F_ByLayer_DivVsHitRate.svg");
