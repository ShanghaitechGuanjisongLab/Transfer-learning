% English Fig5D: model response heterogeneity during learning, Naive vs
% Transfer, by layer and neuron type. Data: shared model cache top-level
% Heterogeneity (per-mouse mean across-cell SD of cue response during formal
% Cue B learning; L23E/L23I/L5E/L5I, n = 50 simulated mice per group).
% Layout mirrors Chinese Fig63E (two stacked tiles L2/3 and L5, E and I bar
% pairs within each tile) but compares Naive vs Transfer instead of Normal vs
% TH inhibited. P-values reported: rank-sum per pair (English-figure caliber,
% same as Fig3C/Fig4D).
%
% Claim: inherited Cue A training raises response heterogeneity in both layers
% before Cue B learning, which the model links to faster transfer (Fig5B).
%
% Outputs (SVG):
%   - English_Fig5D_ModelNaiveTransferHeterogeneity.svg
%
% Execution (hard requirement):
% - Keep this file as a script (do NOT convert to function).
% - Open in MATLAB Editor and Run/F5.

svgName = "English_Fig5D_ModelNaiveTransferHeterogeneity.svg";
...
layerLabels = ["L2/3", "L5"];
cellTypeLabels = ["E", "I"];
groupFields = ["Naive", "Transfer"];
groupLabels = ["Naive", "Transfer"];
...
fig = figure('Color', 'w', 'Name', 'English Fig5D model Naive Transfer heterogeneity');
...
fprintf('=== English Fig5D model Naive vs Transfer heterogeneity ===\n');
...
assignin('base', 'Fig5D_ModelHeterogeneity', Heterogeneity);
assignin('base', 'Fig5D_ModelHeterogeneitySummary', SummaryTable);
