% English Fig1D: two representative cells (Naive / Learned / Transfer) trial
% curves. English-side copy of 中文图/Fig44D_TwoRepresentativeCellTraces.m
...
f = figure('Name', 'English Fig1D two representative cell traces', Units='centimeters'); %[output:3b858469]
...
svgPath = 'English_Fig1D_TwoRepresentativeCellTraces.svg';
svgPath = TransferLearning.ExportStandardFigure(f, 1, svgPath); %[output:3b858469]
fprintf('Wrote: %s\n', svgPath); %[output:84c73696]

assignin('base', 'Fig1D_NaiveRepresentative', naiveRep);
assignin('base', 'Fig1D_TransferRepresentative', transferRep);
