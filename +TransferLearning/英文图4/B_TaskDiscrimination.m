% English Fig4B: RSPd NTATS heatmap (Learned AudioWater vs Transfer LightWater Hit/Miss)
%
% Cell sorting: by (Learned - TransferMiss) difference at 1s, descending
% Active filter: 3σ above baseline in any of the 3 lanes at 1s
%
% Execution:
...
% --- 2) Query 3 lanes: Learned AW, Transfer Hit LW, Transfer Miss LW
...
% Filter: keep cells active at 1s in any lane
...
% --- 4) Sort by (Learned - TransferMiss) at 1s
XL = squeeze(XFull(:,:,1));
...
% Color limits (symmetric, sqrt-scale)
