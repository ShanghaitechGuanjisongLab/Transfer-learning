function [Result, Mouse, State] = SimulateFormalTrainingWithInhibitoryStats(Mouse, Params, Cond, numSessions, InitialState)
...
for iSession = completedSessions + 1:numSessions
	...
	[perf(iSession), Signals, ~, Mouse] = TransferLearning.THModel.SimulateSessionWithInhibitoryStats(Mouse, Params, Cond, false);
	lastSignals = Signals;
