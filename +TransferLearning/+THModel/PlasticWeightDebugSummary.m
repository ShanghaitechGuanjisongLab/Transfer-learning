...
rewardWeights = TransferLearning.THModel.GatherValue(Mouse.W_RewardToL5RewardRecv(:));
...
weightSummary.L5ReadWIECapFraction = mean(l5ReadWIE >= 0.999 * Params.InhWeightMax, 'omitnan');
weightSummary.L5ReadWEIMean = mean(l5ReadWEI, 'omitnan');
weightSummary.L5ReadWEIZeroFraction = mean(l5ReadWEI <= 0, 'omitnan');
weightSummary.L5ReadWEICapFraction = mean(l5ReadWEI >= 0.999 * Params.InhWeightMax, 'omitnan');
end
