...
for iS = 1:2
    ...
    uilabel(fig, 'Text', 'X: Time (0~2 s)', 'FontSize', 7, 'FontColor', [0.85 0.1 0.1], 'Position', [5, 48, 200, 16], 'BackgroundColor', 'none');
    uilabel(fig, 'Text', 'Y: Cell (sorted by z@1s)', 'FontSize', 7, 'FontColor', [0.1 0.6 0.1], 'Position', [5, 30, 200, 16], 'BackgroundColor', 'none');
    uilabel(fig, 'Text', 'Z: Trial', 'FontSize', 7, 'FontColor', [0.1 0.1 0.85], 'Position', [5, 12, 200, 16], 'BackgroundColor', 'none');
...
for iS = 1:2
    yl = ylim(histAxes(iS));
    ylim(histAxes(iS), [yl(1), yl(2) * 1.25]);
end
for iS = 1:2
