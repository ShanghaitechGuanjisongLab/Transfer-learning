% Fig3.3C: P(N|L) vs Naive hit rate (split by layer)
%
...
%
% Execution:
%   TransferLearning.Fig33.C_PNgivenLLW_vsNaiveHitRate
...
if isempty(R)
	error('Fig33C:Empty', 'No valid mice for P(N|L).');
end

layerNames = string(["MOp2/3","MOp5"]);
outDir = iSelectOutDir(outDirUNC);
svgName = "Fig3_3c_PNgivenLLW_vsNaiveHitRate_2panels.svg";

f = figure('Color','w', 'Name','Fig3.3C P(N|L) vs Naive hit rate');
