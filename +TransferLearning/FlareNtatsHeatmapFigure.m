function Fig = FlareNtatsHeatmapFigure(Mode)
arguments
...
if isempty(idxLearnedDT) || isempty(idxTransferDT) || isempty(idxFinalDT)
	error('Cannot find Learned/Transfer/Final in F.DateTimes.Phase.');
end
