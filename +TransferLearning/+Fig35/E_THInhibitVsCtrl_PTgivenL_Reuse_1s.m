...
%
% Execution:
%   TransferLearning.Fig35.E_THInhibitVsCtrl_PTgivenL_Reuse_1s

outDirUNC = "\\Data-Server-2\个人数据\张天夫\202601";
svgName = "Fig3_5e_THInhibitVsCtrl_PTgivenL_Reuse_1s.svg";
...
if isempty(RCtrl) || isempty(RTH)
	error('Fig3_5e:EmptyBuild', 'Empty rows from P(T|L) builder.');
end
...
assignin('base','Fig3_5e_THInhibitVsCtrl_Rows', rows);
...
assignin('base','Fig3_5e_THInhibitVsCtrl_Stats', Stats);

% --- Plot
f = figure('Color','w', 'Name','Fig3.5E THInhibit vs Ctrl');
try
