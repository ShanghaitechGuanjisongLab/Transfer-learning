...
%
% Execution:
%   TransferLearning.Fig35.G_Vacation7VsCtrl_PTgivenF_Reuse_1s

outDirUNC = "\\Data-Server-2\个人数据\张天夫\202601";
svgName = "Fig3_5g_Vacation7VsCtrl_PTgivenF_Reuse_1s.svg";
...
if isempty(RCtrl) || isempty(RExp)
	error('Fig3_5g:EmptyBuild', 'Empty rows from P(T|F) builder.');
end
...
if isempty(R)
	error('Fig3_5g:Empty', 'No valid mice for reuse analysis.');
end
...
assignin('base','Fig3_5g_Vac7VsCtrl_Rows', R);
...
assignin('base','Fig3_5g_Vac7VsCtrl_Stats', Stats);

% Plot
f = figure('Color','w', 'Name','Fig3.5G P(T|F) Vacation7 vs Ctrl');
try
