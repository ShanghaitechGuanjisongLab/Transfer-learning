% Fig3.5F：TH 抑制组 vs 对照组 的“会话 vs 光水最终会话”相关性（NTATS@1.5s）
%
% 口径：
...
%
% Execution:
%   TransferLearning.Fig35.F_THInhibitVsCtrl_Corr_SessToFinal_1p5s

outDirUNC = "\\Data-Server-2\个人数据\张天夫\202601";
svgName = "Fig3_5f_THInhibitVsCtrl_Corr_SessToFinal_1p5s.svg";
...
if isempty(T)
	error('Fig3_5f:Empty', 'No valid mice for correlation analysis.');
end
assignin('base','Fig3_5f_THInhibitVsCtrl_ByMouseLayer', T);
...
assignin('base','Fig3_5f_THInhibitVsCtrl_Stats', Stats);

% --- Plot
f = figure('Color','w', 'Name','Fig3.5F Corr(sess, final)@1.5s');
try
