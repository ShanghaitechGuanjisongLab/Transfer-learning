% 英文图2E：Naive声水 vs 学会声水 Divergence，分 L2/3 / L5 上下 tile
%
...
%
% Execution:
%   TransferLearning.英文图2.E_NaiveVsLearnedAW_DivByLayer
...
fprintf('\n=== Panel E: NaiveAW vs LearnedAW Div by layer (paired signrank) ===\n');
...
% --- Export ---
svgPath = fullfile(outDirUNC, "English_Fig2E_NaiveVsLearnedAW_DivByLayer.svg");
TransferLearning.PrintFigure(f, svgPath);

% --- Summary to base workspace ---
assignin('base', 'Fig2E_NaiveAW_L23', divNaiveL23);
assignin('base', 'Fig2E_LearnedAW_L23', divLearnedL23);
assignin('base', 'Fig2E_pL23', pL23);
assignin('base', 'Fig2E_NaiveAW_L5', divNaiveL5);
assignin('base', 'Fig2E_LearnedAW_L5', divLearnedL5);
assignin('base', 'Fig2E_pL5', pL5);
