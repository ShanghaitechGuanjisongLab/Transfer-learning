...
%% ===== 6) Save to workspace =====
assignin('base', 'English_Fig2M_R', R);
assignin('base', 'English_Fig2M_pReact', pReact);
assignin('base', 'English_Fig2M_DivCtrl', xDivCtrl);
assignin('base', 'English_Fig2M_DivVac7', xDivV7);
assignin('base', 'English_Fig2M_pDiv', pDiv);
