% Fig3.7F：比较 放假7天组 vs 对照组 的“会话 vs 光水最终会话”相关性（NTATS@1.5s）
%
% 参考：Fig3.6H（分组口径） + Fig3.4F（相关性统计与画法）。
...
%
% Execution:
%   TransferLearning.Fig37.F_PTgivenF_HitVsMiss

outDirUNC = "\\Data-Server-2\个人数据\张天夫\202601";
svgName = "Fig3_7f_Vacation7VsCtrl_Corr_TransferVsLearned_1p5s.svg";
...
if isempty(T)
	error('Fig3_7f:Empty', 'No valid mice for correlation analysis.');
end
assignin('base','Fig3_7f_Vac7VsCtrl_ByMouseLayer', T);
...
assignin('base','Fig3_7f_Vac7VsCtrl_Stats', Stats);

% --- Plot
f = figure('Color','w', 'Name','Fig3.7F Corr(Transfer vs Learned)@1.5s');
try
