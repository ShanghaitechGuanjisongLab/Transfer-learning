%% Swarmchart: Naive merged vs Transfer (DeltaF)
...
ylabel(ax, 'Divergence (DeltaF)');
title(ax, 'Naive merged vs Transfer (DeltaF, swarm)');
box(ax,'on');
...
svgPath = fullfile(outDirUNC, 'NaiveMergedVsTransfer_Divergence_Swarmchart_DeltaF.svg');
pngPath = fullfile(outDirUNC, 'NaiveMergedVsTransfer_Divergence_Swarmchart_DeltaF.png');
