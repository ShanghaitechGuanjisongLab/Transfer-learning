...
defaultCfg = struct(...
	...
	'RecomputeOverlays', false, ...      % 重新计算 scFLARE/Vacation7/THInhibit summary
...
if cfg.ExportHitMiss
	...
	if cfg.ExportReverse && all(ismember({'ReuseRate_TransferMedianActive_Hit','ReuseRate_TransferMedianActive_Miss'}, Summary.Properties.VariableNames))
