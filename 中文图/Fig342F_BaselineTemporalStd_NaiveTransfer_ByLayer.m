...
svgName = "中文图Fig342F_BaselineTemporalStd_NaiveTransfer_ByLayer.svg";
...
for iL = 1:numel(layers)
	...
	iStyleTile(ax, bars, errorBars, optional, palette2(1, :), palette2(2, :), iL == numel(layers), layerLabels(iL), p);
end
