...
[naiveRep, transferRep] = iPickRepresentatives(LAB, LAI, ALB, (xsSec >= -3) & (xsSec < 0), idx1s, 3);
...
ax1.XTickLabel(ismember(ax1.XTick, [0, 1])) = {"💡", "💧"};
ax2.XTickLabel(ismember(ax2.XTick, [0, 1])) = {"🔊", "💧"};
ax3.XTickLabel(ismember(ax3.XTick, [0, 1])) = {"💡", "💧"};
