...
f = figure('Color', 'w', 'Name', '中文图71A Baseline convergence PC1 trajectory');
f.Units = 'centimeters';
...
svgPath = '中文图Fig71A_BaselineConvergence_PC1Trajectory.svg';
...
assignin('base', 'Fig71A_SelectedBlock', repBlock);
assignin('base', 'Fig71A_BlockScores', blockScores);
assignin('base', 'Fig71A_TrialPc1', trialPc1);
