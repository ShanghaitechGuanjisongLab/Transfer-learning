...
svgName = "中文图Fig53C_ResponseHeterogeneityVsPathOverDirect_ByLayer.svg";

StateData = TransferLearning.Fig51.BuildStateSpaceSummary(false, UniExp.Flags.No_special_operation);
...
builtin('text', ax, 0.95, 0.95, iPLabel(p), 'Units', 'normalized', ...
