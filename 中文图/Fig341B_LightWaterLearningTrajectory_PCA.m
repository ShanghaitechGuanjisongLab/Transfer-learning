...
f = figure('Color', 'w', 'Name', '中文图341B LightWater learning trajectory PCA');
f.Units = 'centimeters';
f.Position(3:4) = [12, 8];
...
svgPath = fullfile(outDirUNC, '中文图Fig341B_LightWaterLearningTrajectory_PCA.svg');
TransferLearning.PrintFigure(f, svgPath, ForceLegendOrColorbar=true);
fprintf('Wrote: %s\n', svgPath);

assignin('base', 'Fig341B_NaiveTrajectory', Naive);
assignin('base', 'Fig341B_TransferTrajectory', Transfer);
