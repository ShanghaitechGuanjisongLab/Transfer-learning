% 中文图383B：声水活跃细胞，首次迁移光水 0~3 s Ctrl/TH z-score 均值线
...
Data = Fig383BC_THInhibitCtrlActiveCalciumData();
[lineMean, lineSem] = iZeroAlignedLineStats(Data);

f = figure('Color', 'w', 'Name', '中文图383B TH/Ctrl learned-active calcium lines');
f.Units = 'centimeters';
f.Position(3:4) = [12, 8];
...
lineColors = TransferLearning.FigurePalette(2);
