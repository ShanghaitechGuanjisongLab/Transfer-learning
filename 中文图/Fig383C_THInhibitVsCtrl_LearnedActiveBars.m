% 中文图383C：声水活跃细胞，1~3 s 响应与 TH 下降量
...
f = figure('Color', 'w', 'Name', '中文图383C learned-active calcium bars');
f.Units = 'centimeters';
f.Position(3:4) = [3, 4];
...
svgPath = '中文图Fig383C_THInhibitVsCtrl_LearnedActiveBars.svg';
svgPath = TransferLearning.ExportStandardFigure(f, 1, svgPath);
fprintf('Wrote: %s\n', svgPath);

assignin('base', 'Fig383C_Data', Data);
