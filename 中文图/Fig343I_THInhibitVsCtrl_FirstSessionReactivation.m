...
svgName = "中文图Fig343I_THInhibitVsCtrl_FirstSessionReactivation.svg";
...
if isempty(RCtrl) || isempty(RTH)
	error('Fig343I:Empty', 'No valid mice for first-session reactivation comparison.');
end
...
if isempty(xCtrl23) || isempty(xTH23) || isempty(xCtrl5) || isempty(xTH5)
	error('Fig343I:NoFiniteData', 'No finite layer-wise reactivation values in one or both groups.');
end
