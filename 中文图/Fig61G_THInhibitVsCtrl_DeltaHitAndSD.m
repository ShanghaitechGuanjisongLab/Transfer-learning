...
% Re-read tagged PLine/PText objects and update Optional.MultiCompare.
% Run after SetBarPValues has set numbered tags. Outputs Bars/ErrorBars/Ax are dummy passthrough.
