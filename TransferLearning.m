classdef(Abstract)TransferLearning
	...
	properties(Constant)
		...
		NaiveColor=[1.0000    0.4243    0.0000];
		LearnedColor=[0.0000    0.6731    0.0000];
		ContinualColor=[1.0000    0.0000    1.0000];
		ColorA=[0.0000    1.0000    1.0000];
		ColorB=[0.0000    0.3119    1.0000];
